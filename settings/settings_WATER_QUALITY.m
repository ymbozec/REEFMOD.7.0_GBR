...
id1_wq = randi(6); % randomly select one of the 6 years
id2_wq = randi(6); % randomly select one of the 6 years
...
REEF_POP(1).CORAL_larvae_production = GBR_REEF_POP(id1_wq).CORAL_larvae_production(META.reef_ID,1); % no need of winter values
...
REEF_POP(8).CORAL_larvae_production = GBR_REEF_POP(id2_wq).CORAL_larvae_production(META.reef_ID,1); % no need of winter values