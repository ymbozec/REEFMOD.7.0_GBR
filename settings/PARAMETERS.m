...
% Heritability of heat tolerance (h2)
CORAL.heritability_HT = 0.3 * [1 ; 1 ; 1 ; 1 ; 1 ; 1 ]; % defined as the proportion of the total phenotypic variance made up of the additive genetic variance
