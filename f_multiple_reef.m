...
%% Reef areas
load('GBR_REEF_POLYGONS_2024.mat') % with updated estimates of ungrazable 10/2023
...
META.deterministic_bleaching = 0; % option for generating deterministic (1) vs random (0) mortalities from DHWs
...
META.random_hurricanes = 0; % put 0 to apply a specific scenario (1 imposes complete random occurence of a categor cyclone from 0 to 5)
META.deterministic_hurricane_mortality = 0; % option for generating deterministic (1) or random (0) mortalities from a given cyclone category
...
META.randomize_initial_COTS_densities = 2 ; % Distri for random generation of COTS densities (1 for Gaussian, 2 for Poisson)
...
%% Genetic adaptation (needs revision - not to be confused with the inheritance model of heat tolerance)
